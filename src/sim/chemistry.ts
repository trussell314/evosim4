...
const NAMED_CHEM_SPECS: ReadonlyArray<NamedChemSpec> = [
  ...
  /* vibroreceptor */ { ...RECEPTOR_BASE, color: "#64b0e0" },
  ...
  /* actVibX       */ { ...SIGNAL_BASE,   color: "#a0d0f0" },
  /* actVibY       */ { ...SIGNAL_BASE,   color: "#a0d0f0" },
  /* activatedPh   */ { ...SIGNAL_BASE,   color: "#d0f088" },
  /* actChemoFaY   */ { ...SIGNAL_BASE,   color: "#d0f0f8" },
  /* actLightX     */ { ...SIGNAL_BASE,   color: "#fff8c0" },
  /* actLightY     */ { ...SIGNAL_BASE,   color: "#fff8c0" },
