...
// Particles per emission batch at intensity=1. Scales by intensity^2 so
// warmup/cooldown shed dramatically fewer particles than the peak.
const VENT_BATCH_AT_PEAK = 4;
