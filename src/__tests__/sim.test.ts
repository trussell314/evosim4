...
function quietWorld(): World {
  return {
    ...
    particleTarget: 550, particleSpawnRate: 0, extinctionCount: 0, liveLineageRoots: new Set<number>(), nextLineageRoot: 0, founderTarget: 0, founderIds: new Set<number>(), founderReproduced: new Set<number>(), founderBirthScore: new Map(),
    gravity: 0, drag: 0,
