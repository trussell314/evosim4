...
import {
  ...
  buildTerrainHeightmap, buildTerrainSurfaceMaps, pointInPolygon,
} from "./sim/terrain";
...
export { REGION_PX, regionCols, regionRows, regionVolumeL, regionDissolvedCapacity };
export {
  type WorldEnv,
  WIND_MAX, LIGHT_DECAY,
  surfaceActivity, windExposureAt, waveOriginAt, shoalAt, surfaceYAt,
...
// model live in ./sim/regions; the state-bearing field stepping
// (temperature diffusion, ambient / reserve diffusion) is below.
// ===================================================================
